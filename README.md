...
3. בלשונית **יצירת סקר** בנו 1–3 שאלות, ידנית או דרך ChatGPT, בחרו תזמון ולחצו **התחל סקר**.
...
| +3:00 | תזכורת אישית למי שטרם סיים |
| +4:30 | אזהרה אחרונה |
| +5:00 | הסקר נסגר אוטומטית |

הערכים מוגדרים ב-`AppConfig`.
...
19 בדיקות יחידה המכסות את לוגיקת הסקר, התזמון וניהול הקהילה —
כולל מניעת מרוץ בין הטיק האחרון לסגירת הסקר, תזכורות למי שטרם סיים,
ביטול סקר בשלב ההמתנה, והפרדת הרשויות בין חברי קהילה למשתתפי סקר.
